<template>
  <div>
    <div style="margin-bottom: 15px">
      <el-input v-model="params.position" style="width: 200px" placeholder="请输入教室位置"></el-input>
    ...
    <el-table
      ...
      <el-table-column prop="size" label="教室容量(单位:班级)" ></el-table-column>
    ...
    <div>
      <el-dialog title="请填写信息" :visible.sync="dialogFormVisible" width="30%">
        <el-form :model="form">
          <el-form-item label="教室位置" label-width="15%">
            <el-input v-model="form.position" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="教室容量(单位:班级)" label-width="15%">
            <el-input v-model="form.size" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    del(id){
      request.post("/classroom/"+id).then(res =>{
        if(res.code === '0'){
          this.$message({
            message: '删除成功！',
            type: 'success'
